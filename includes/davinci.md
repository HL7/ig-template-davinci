...
All Da Vinci work adheres to a common set of 
{% if site.data.fhir.ver.hrex != '' %}
[guiding principles]({{site.data.fhir.ver.hrex}}/davinci-guiding-principles.html).
{% else %}
[guiding principles](davinci-guiding-principles.html).
{% endif %}
